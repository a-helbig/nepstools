...
2.  [`replace_season_codes()`](https://a-helbig.github.io/nepstools/reference/replace_season_codes.md):
    recoding season codes to corresponding months
3.  [`expand()`](https://a-helbig.github.io/nepstools/reference/expand.md):
    expanding episode data by duration
4.  [`question()`](https://a-helbig.github.io/nepstools/reference/question.md):
    wrapper of attr function for printing question texts
