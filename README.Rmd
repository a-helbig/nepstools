...
If this package contributes to your research, please consider citing it. I would greatly appreciate it.

Suggested citation:

Alexander Helbig (2026). *nepstools*. Version 0-1-4 [Computer software]. https://github.com/a-helbig/nepstools
...
The package provides a handful of smaller functions that facilitate working with NEPS data:
