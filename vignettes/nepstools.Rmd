---
title: "Introduction to nepstools"
...
```{r expand}
# read data with variables: "ID" and "enddate of episode"
df_neps <- read_neps(path, col_select = c("ID_t", "ts2911m", "ts2911y", "ts2912m", "ts2912y"))
df_neps <- df_neps[-1,] # get rid of NA row that is in every semantic structure file from NEPS
